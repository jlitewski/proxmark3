...
#ifndef __PRINTBRIDGER_H
#define __PRINTBRIDGER_H
...
#define print_trace(...)           { if(g_dbglevel >= 2) Dbprintf(__VA_ARGS__); }
#define print_debug(...)           { if(g_dbglevel >= 3) Dbprintf(__VA_ARGS__); }
#define print_critical(...)        { if(g_dbglevel >= 1) Dbprintf(__VA_ARGS__); }
#define print_error(...)           { if(g_dbglevel >= 1) Dbprintf(__VA_ARGS__); }
#define print_warning(...)         { if(g_dbglevel >= 1) Dbprintf(__VA_ARGS__); }
