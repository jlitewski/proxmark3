...
static command_t CommandTable[] = {
    ...
    {"clear",            CmdBuffClear,            AlwaysAvailable,  "Clears the various graph buffers"},
    {"hide",             CmdHide,                 IfGUIEnabled,     "Hide the graph window"},
    {"load",             CmdLoad,                 AlwaysAvailable,  "Load contents of file into the graph buffers"},
    {"num",              CmdNumCon,               AlwaysAvailable,  "Converts dec/hex/bin"},
    {"plot",             CmdPlot,                 IfGUIEnabled,     "Show the graph window"},
